...
Insert into @table values ('SettlementMix','20111101','20110101','20130430' )
...
set @maxIndex=(select MAX(JobIndex) from @table)
  ...
  while @index<=@maxIndex
	begin
		...
		set @jobName='Settlement-'+(SELECT FilterName FROM @table WHERE JobIndex=@index)
		...
		begin
			...
			INSERT INTO StoredJobParameters VALUES (@maxStoredJobId,'Resolution_0','Day')
			...
			INSERT INTO StoredJobParameters VALUES (@maxStoredJobId,'AbsoluteFromDate_0','20101201')
			...
			INSERT INTO StoredJobParameters VALUES (@maxStoredJobId,'AbsoluteToDate_0','20130501')
			INSERT INTO StoredJobParameters VALUES (@maxStoredJobId,'ToDateOffset_0','0')
			
			INSERT INTO StoredJobParameters VALUES (@maxStoredJobId,'TimeSeriesType_1','Settlement')
			INSERT INTO StoredJobParameters VALUES (@maxStoredJobId,'Resolution_1','Day')
			INSERT INTO StoredJobParameters VALUES (@maxStoredJobId,'Alias_1','Settlement-Day')
			...
			INSERT INTO StoredJobParameters VALUES (@maxStoredJobId,'TimeSeriesType_2','Settlement')
			INSERT INTO StoredJobParameters VALUES (@maxStoredJobId,'Resolution_2','Month')
			INSERT INTO StoredJobParameters VALUES (@maxStoredJobId,'Alias_2','Settlement-Month')
