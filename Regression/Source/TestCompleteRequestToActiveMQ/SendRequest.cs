...
namespace TestCompleteRequestToActiveMQ
{
    ...
    public class SendRequest
    {
        ...
        //  [Test]
        public static string SendToQueue(string filename)
        {
            //string filename = @"E:\Shared\CurveServer\Adapter\TestFiles\month.xml";
      ...
      //  [Test]
        public static void RevertAllConfigurationsToDefault()
        {
