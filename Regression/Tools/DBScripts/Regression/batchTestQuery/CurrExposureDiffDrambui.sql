...
set @workspace='gas-forward-gjd-eur-currexposure-nok'
...
INSERT INTO @brandyTable(
						...
						(
							SELECT					
							  ...
							  FROM QADatawareHouse_Reg131.dbo.[VizCurrExposureData]
							  WHERE [ReportId]=(
													SELECT [ReportId] FROM QADatawareHouse_Reg131.dbo.[VizCurrExposureReports]
													WHERE [Workspace]=@workspace
													AND [MonitorTitle]=@workspace
													AND [ReportDate]=@reportDate
												)
