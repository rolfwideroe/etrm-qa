...
$msiFilesource="\\BERSVDEPLOY\INSTALLATIONS\DEP_TEMP\CCNET\2012.2\CCNET2012.2.msi"
$run_date= Get-Date
$Log_Date= Get-Date -format "yyyyMMdd_HHmm"
$msiFileapth= "C:\elviz\CCNET2012.2.msi"
$ElvizServer="QA122A"
$CCserver="QA122A"
$INSTALLDIR="C:\Elviz"
...
Echo_msg "$LogFileSpecified" "--------------------------------------------------------------- $nl"
	...
	$sNames =@("Elviz Message Queue Listener Service","ElvizContractClearer","Elviz PriceBoard Service","ElvizNasdaqOMXadapter","ActiveMQ")
